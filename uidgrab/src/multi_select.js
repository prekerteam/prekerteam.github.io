    ...
    var methods = {
        init: function (options) {
            ...
            select = $(
                ...
                '      <button type="button" onclick="selectAll(' + selectId + ', ' + settings.multi_select + ')"><span class="glyphicon glyphicon-check" aria-hidden="true"></span></button>' +
                '      <button type="button" onclick="deselectAll(' + selectId + ')"><span class="glyphicon glyphicon-unchecked" aria-hidden="true"></span></button>' +
                '   </div>' +
