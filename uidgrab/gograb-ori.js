...
function goGrab() {
    ...
    function filterID(d, g, c) {
        ...
        for (var i = 0; i < d.length; i++) {
            ...
            if (c != "semua") {
                // console.log("masuk1");
                // if (d[i]["location"] !== undefined && d[i]["location"]["location"] !== undefined && d[i]["location"]["location"]["country"] !== undefined){
                if (d[i]["location"] !== undefined && d[i]["location"]["location"] !== undefined && d[i]["location"]["location"]["country_code"] !== undefined) {
                    // console.log("masuk2");

                    // if (d[i]["location"]["location"]["country"].toUpperCase().indexOf(countries[c.toUpperCase()].toUpperCase()) !== -1){
                    if (d[i]["location"]["location"]["country_code"] == c.toUpperCase()) {
                        if (g == "all") {
                            res.push(d[i]["id"]);
                        }
    ...
    function Grab(next = 0, pindahtoken = 0) {
        ...
        var getData = {
            ...
            fields: 'id,name,gender,location{location{country,country_code}}' //location{location}'
        };
        // if (next !== undefined) {
        // 	getData.after = next;
        // } else {
        ...
        if (berhitung - 1 < UIDs.length && $("#run").val() == 1) {
            ...
            // /?fields=id,gender,location{location{country_code}}&access_token=
